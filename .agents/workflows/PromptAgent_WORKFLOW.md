...
2. **Thu thập dữ liệu**: Đọc ảnh tham chiếu (nếu có) hoặc bối cảnh trong `active_project.md`.
...
5. **Đầu ra**: Xuất prompt trong block code và cập nhật vào `prompt_studio/active_project.md`.
...
- **Bước 3**: Lưu phương án được chọn vào `active_project.md`.
