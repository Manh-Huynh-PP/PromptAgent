...
1. **Build the 3-Act Structure**:
   - **Act 1: The Setup (Intro)** - Establish the context and environment. (Camera move: push-in, reveal).
   - **Act 2: The Action (Impact)** - The climax of the action sequence. (Camera move: tracking, whip pan).
